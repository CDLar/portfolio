...
const Skills = () => {
  ...
  return (
    <Wrapper>
      ...
      <ContentWrapper>
        <PictureWrapper>
          <TreeTitle>{"<SkillTree />"}</TreeTitle>
          <SkillTree src={activeTree} alt="tree" />
        </PictureWrapper>
        <SkillsWrapper>
          <SkillWrapper
            onMouseEnter={() => setActiveTree(skillTreeCore)}
            onMouseLeave={() => setActiveTree(skillTree)}
          >
            <Fade top>
              <SkillTitle>{"<Core />"}</SkillTitle>
            </Fade>
            <Fade left>
              <SkillText>
          ...
          <SkillWrapper
            onMouseEnter={() => setActiveTree(skillTreeDev)}
            onMouseLeave={() => setActiveTree(skillTree)}
          >
            <Fade top>
            ...
            <Fade left>
              <SkillText>
                ...
                <ColorText>Node.js</ColorText>, initialize projects with{" "}
                <ColorText>Webpack</ColorText> and handle my workflow and source
                control with <ColorText>Git</ColorText> and{" "}
                <ColorText>Git Bash</ColorText>. I am capable of rendering both
                client-side and server-side apps using the{" "}
                <ColorText>Next.js</ColorText> framework.
              </SkillText>
            </Fade>
          </SkillWrapper>
          <SkillWrapper
            onMouseEnter={() => setActiveTree(skillTreeDesign)}
            onMouseLeave={() => setActiveTree(skillTree)}
          >
            <Fade top>
            ...
            <Fade left>
              <SkillText>
                I'm experienced with a wide variety of styling options, I prefer
                to use CSS-in-JS libraries such as{" "}
                <ColorText>Styled Components</ColorText> but have also created
                several projects with <ColorText>CSS Modules</ColorText> and
                other CSS preprocessors like <ColorText>SASS</ColorText>. I also
                have knowledge of using design frameworks such as{" "}
                <ColorText>Material-UI</ColorText>.
              </SkillText>
            </Fade>
          </SkillWrapper>
        </SkillsWrapper>
